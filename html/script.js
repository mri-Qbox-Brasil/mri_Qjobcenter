...
window.addEventListener('message', function(event) {
    if (event.data.type == "open") {
        ...
        Object.entries(config.Jobs).forEach(([jobKey, job]) => {
            var dynamicContent = `
            <div class="mx-auto max-w-md overflow-hidden rounded-lg h-[51rem] bg-neutral-800 mb-10" style="display: none" id="job-${jobKey}">
                ...
                <div class="p-4">
                    ...
                    <div class="mx-auto max-w-lg">
                        <ul class="list-disc text-sm text-gray-300 opacity-85 h-40 overflow-hidden list-none bg-neutral-900 px-2 py-1.5 mt-5 rounded-md">
                            <h1 class="font-medium text-gray-300 mb-1 text-base">Instruções de trabalho</h1>
                            <li class="font-normal">${job.instructions}</li>
                        </ul>
                    </div>
                    <div class="mx-auto max-w-lg">
                    <ul class="list-disc text-sm text-green-900 bg-opacity-85 h-[140px] overflow-hidden list-none bg-emerald-200 px-2 py-1.5 mt-5 rounded-md">
                            <h1 class="font-medium text-green-800 mb-1 text-base">Remuneração por</h1>
        ...
        //     var dynamicContent = `
        //     <div class="mx-auto max-w-md overflow-hidden rounded-lg h-[29rem] bg-neutral-800 mb-10" style="display: none" id="license-${licenseKey}">
